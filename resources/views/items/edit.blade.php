...
@section('scripts')
	...
	{!! Html::script('https://cdn.ckeditor.com/ckeditor5/32.0.0/classic/ckeditor.js') !!}
	<script>
    ClassicEditor
	...
	<div class="row">
		...
		<div class="col-md-6 col-md-offset-2">
			...
			{{ Form::label('title', 'Name:') }}
			    ...
			    {{ Form::textarea('description', null, ['class'=>'form-control', 'data-parsley-required'=>'true', 'id'=>'editor']) }}
